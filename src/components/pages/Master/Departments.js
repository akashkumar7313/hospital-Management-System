      ...
      <div className="p-3 ">
        <div className="h-auto w-[100%] bg-white border border-blue-600 rounded-[10px]">
          <div className="bg-slate-200 h-[75px] w-full rounded-t-[10px] flex">
            <div className="flex items-center justify-evenly sm:gap-0 md:gap-[230px] lg:gap-[800px]">
              <div className=" sm:px-6 lg:px-5">
                <div className="px-1 ">
                  <div>
                    <h2 className=" mx-4 text-2xl font-semibold">Department</h2>
          ...
          <div className="w-full p-5 ">
            <div className="relative flex flex-col min-w-0 break-words w-full shadow-lg text-black border border-yellow-500 rounded-[10px]">
              <div className= "bg-slate-200 h-[60px] w-[100%] rounded-t-[10px] flex items-center justify-between">
                <p className="font-semibold text-xl px-4 flex items-center gap-2"> <FcAlphabeticalSortingAz className=" h-10 w-8"/>Manage Departments</p>   
                    <button className="px-3 mx-5 py-1 text-black border border-yellow-500 rounded hover:bg-black hover:text-white flex gap-1">
                      <FcPlus className="mt-1" /> Add Department
                    </button>
              </div>
              <hr className="h-[1px] bg-gray-400 border-1"></hr>
