              ...
              <table className="items-center w-full bg-transparent border-collapse">
                <thead className="sticky top-0">
                  <tr>
                    ...
                    <th className="px-6 align-middle py-2 text-[16px] uppercase whitespace-nowrap font-semibold text-left bg-cyan-500 text-white border-cyan-500"></th>
                  </tr>
                </thead>
                <tbody>
                  {dynamicData.map((item, index) => (
                    <tr key={index}>
                      <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-[16px] whitespace-nowrap p-4 text-left flex items-center">
                        <img
                          src={item.users[0]}
                          className="h-9 w-9 bg-white rounded-[5px] border"
                          alt="..."
                        />
                      </th>
                      <td className="border-t-0 px-6 align-middle text-pink-500 border-l-0 border-r-0 text-[16px] whitespace-nowrap p-4">
                        {item.name}
                      </td>
                      <td className="border-t-0 px-6 align-middle text-blue-600 border-l-0 border-r-0 text-[16px] whitespace-nowrap p-4">
                        {item.department}
                      </td>
                      <td className="border-t-0 px-8 align-middle border-l-0 border-r-0 text-[16px] whitespace-nowrap p-4">
                        <button
