                ...
                <tbody>
                  {dynamicData.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="border-t-0 px-6 align-middle border-l-0 text-pink-700 border-r-0 text-[16px] whitespace-nowrap p-4">
                        {item.mrNumber}
                      </td>
                      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-blue-600 text-[16px] whitespace-nowrap p-4">
                        <i className="fas fa-circle text-orange-500 mr-2"></i>
                        {item.reportNumber}
                      </td>
                      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-[16px] whitespace-nowrap p-4 px-10">
                        <button
